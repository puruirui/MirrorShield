...
if __name__ == '__main__':
    ...
    # change to './vicuna/gen_results/gpt-4o_nodefense_output_withsystem_max1024.json' for vicuna_eval test
    ref_path = './alpaca/gen_results/gpt-4o_output_withsystem.json'
